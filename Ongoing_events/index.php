...
<div class="container">
  <div class="header"> <a href="#"><img src="images/logo.png"  name="Insert_logo" width="150" height="90" id="Insert_logo" style="padding-top:20px; padding-left:15px; height:110px;" /></a> 
  <h2 style="text-align:center;margin-left:50px; margin-top:-70px;">National Institute of Technology, Tiruchirappalli</h2>
 
    <!-- end .header --></div>
  <div class="content">
    <!--<h1>Instructions</h1>-->
    <center><h3>ON GOING EVENTS IN CAMPUS</h3></center>
    <center>
    <div class="rain">
			<div class="border start">
				<form id="form1" name="form1" method="post" action="loginvalidate.php">
					<label for="email">Webmail Id</label>
					<input  type="text" placeholder="Webmail Id" name="id" id="id"/>
					<label for="pass">Password</label>
					<input  type="password" placeholder=" Webmail Password" name="pass" id="pass"/>
  ...
  <div class="footer">
    <center><p>transcript@nitt.edu</p></center>
    <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>
